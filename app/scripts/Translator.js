...
function Translator() {
    ...
    this.translateLanguage = function(text, config) {
        ...
        var source = 'https://www.googleapis.com/language/translate/v2?key=' + api_key + '&source=' + (config.from || 'it') + '&target=' + (config.to || 'en') +  '&callback=window.' + randomNumber + '&q=' + sourceText;
