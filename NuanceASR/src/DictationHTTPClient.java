...
import streamer.FileAudioStreamer;
...
public class DictationHTTPClient {
	...
	private static String DEVICE_ID = "0000";
	private static String LANGUAGE = "it_IT";
	private String CODEC = "audio/x-wav";	//MP3
	...
	private String audioFile = "D:\\bellag.wav";
	...
	public static void main(String[] args) throws Exception
	{
		...
		DEVICE_ID="";
		LANGUAGE="";
		BufferedReader br = new BufferedReader(new FileReader("..\\conf\\DRAGON.txt"));
	    try {
